...
(defn- g-button [click-fn]
  [:div.googleButton.googleButtonLightBlue
   {:onClick click-fn :style {:height "36px" :width "200px" :margin-bottom "1em" :margin-right "0.4em"}}
   [:div.googleButtonContentWrapper
    [:div.googleButtonIcon {:style {:padding "8px"}}
     [:div.googleButtonSvgImageWithFallback.googleButtonIconImage.googleButtonIconImage18
      {:style {:width "18px" :height "18px"}}
      [:svg.googleButtonSvg {:viewBox "0 0 48 48" :height "18px" :width "18px" :version "1.1"}
       [:g
             ...
             [re-com/v-box
              ...
              [[re-com/h-box
               ...
               [re-com/h-box
                ...
                :children
                [[:div {:class "g-signin2" :data-onsuccess "loginFromGoog" :data-prompt "select_account" :style {:display "none"}}]
                 [g-button
                  (fn []
                    (interop/google-login!
